...
public class Configurator {
    ...
    /**
     * Zapis wybranego parametru do pliku konfiguracyjnego
     * @param configChoice
     */
     ...
     * @return
     */
    public int getLivesAmount(){ return this.livesAmount; }
    ...
    public void setLivesAmount(int la){ this.livesAmount = la; }
